...
<div class="row">
<div class="col-md-4">Ditt namn: <span class="error">* <?php echo $nameErr;?></span></div><div class="col-md-8"><input type="text" id="customer_name" name="customer_name" /><br /></div>
</div>
<div class="row">
<div class="col-md-4">
  Din Email: 
...
<div class="col-md-8"><input type="text" id="customer_email" name="customer_email" /><br /></div>
</div>
<div class="row">
